...
First, load in the first 2,000,000 rows of the `train.csv` file. There are actually 40 million observations (it's a big dataset). Check out the data with `str`
```{r}
